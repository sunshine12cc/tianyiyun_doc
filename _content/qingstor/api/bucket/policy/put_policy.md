...
获取 Policy 请参见 [GET Bucket Policy](get_policy.html#object-storage-api-get-bucket-policy) 。

删除 Policy 请参见 [DELETE Bucket Policy](delete_policy.html#object-storage-api-delete-bucket-policy) 。
...
| condition | dict | 允许策略生效的条件, 可缺省。总长度不能超过2048个字符。condition详细介绍请参见 [Bucket Policy Condition](policy_condition.html#object-storage-api-bucket-policy-condition) |
