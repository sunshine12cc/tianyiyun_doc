...
qsctl 已升级至 v2.2.0 版本，如果您需要查看 qsctl v1.x 版本的文档，请点击 [qsctl v1 文档](qsctl_v1.html)；建议您升级至 qsctl v2.2.0 版本，如果您担心兼容性问题，请查看 [qsctl 升级指南](qsctl_v2_update.html) 来确认兼容性问题后使用。
如果您在使用过程中遇到任何问题，请通过工单联系我们。

## 变更日志

详见 [qsctl v2 版本变更日志](qsctl_changelog.html)。
...
在 qsctl v2.2.0 版本中，我们新加入了交互式的 shell 界面，包含更多的引导和提示信息，推荐新用户使用。您可以执行 `qsctl shell` 命令进入命令行界面，根据提示进行操作即可。
