...
![容量型硬盘创建](../../_images/create_容量型_1.png)

点击 **创建** 跳出如下界面

![创建容量型硬盘](../../_images/create_容量型_2.png)

在名称框里输入创建的硬盘名称，在数量框里输入需要创建的硬盘数量，在类型中选择容量型，拖动滑动按钮选择容量大小，或者在右边的输入框中输入容量大小，点击 **提交** ，进入如下界面

![完成容量型硬盘创建](../../_images/create_容量型_3.png)
...
![容量型硬盘操作](../../_images/create_容量型_4.png)

![容量型硬盘操作](../../_images/create_容量型_5.png)

**加载容量型硬盘到主机**

点击 **加载硬盘到主机** ，跳出如下界面

![加载硬盘到主机](../../_images/create_容量型_6.png)
...
![加载硬盘到主机](../../_images/create_容量型_7.png)

**修改容量型硬盘名称或属性**

点击 **修改**，跳出如下界面

![修改硬盘属性](../../_images/create_容量型_8.png)
...
![克隆容量型硬盘](../../_images/create_容量型_9.png)

在名称框填入名称，写入拷贝数量，类型选择容量型，点击 **提交** ，进入如下界面

![完成硬盘克隆](../../_images/create_容量型_10.png)
...
![扩容容量型硬盘](../../_images/create_容量型_11.png)

**备份**

点击 **备份** ，跳出如下界面

![备份容量型硬盘](../../_images/create_容量型_12.png)

点击 **继续** ，进入如下界面

![备份容量型硬盘](../../_images/create_容量型_13.png)

在名称框里填入名称，有需要地选择创建新备份链，点击 **提交** 。可以左键点击容量型硬盘条目，进入如下界面

![完成容量型硬盘备份](../../_images/create_容量型_14.png)
...
![硬盘标签](../../_images/create_容量型_15.png)

如果没有标签或已有标签不适用，可以选择 **创建标签** ，或者进行 **标签管理** 。选择标签，点击 **提交** ，进入如下界面

![管理标签](../../_images/create_容量型_16.png)

**添加到项目**

点击 **项目-加入**，跳出如下界面

![加入项目](../../_images/create_容量型_project.png)

选择需要添加到的项目，点击 **提交** 将硬盘添加到项目，回到硬盘列表可以查看硬盘所属的项目，如下图

![完成加入到项目](../../_images/create_容量型_project2.png)
...
![备份容量型硬盘](../../_images/create_容量型_17.png)

鼠标右键点击备份链ID，跳出如下界面

![备份链修改](../../_images/create_容量型_18.png)

**修改备份名称或描述**

点击 **修改** ，跳出如下界面

![修改备份属性](../../_images/create_容量型_19.png)
...
![基于备份完成硬盘创建](../../_images/create_容量型_21.png)
...
![共享备份](../../_images/create_容量型_22.png)
...
![跨区复制备份](../../_images/create_容量型_23.png)
...
![备份属性修改](../../_images/create_容量型_24.png)

鼠标左键点击备份链右侧的 **...** ，可以选择对备份链的修改、创建硬盘、回滚和删除，如下图

![编辑备份链](../../_images/create_容量型_25.png)

## 监控

在容量硬盘挂载到主机时，可以点击硬盘题目，查看监控情况，界面如下

![容量型硬盘监控](../../_images/create_容量型_26.png)
