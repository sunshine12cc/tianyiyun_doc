...
![](_images/create_nas_shared_target.png)
...
![](_images/create_account_nfs.png)

### SMB 类型的账户

通过配置的用户名和密码进行访问控制。

![](_images/create_account_smb.png)
