...
![第5步: 依赖服务设置](zk_node.png)

选择您所依赖的 ZooKeeper 集群。

### 第六步：参数设置

![Kafka 参数设置](kafka_params_setconfig.png)
...
![添加管理的 Kafka 集群 ](kafka-manager_init1.png)

![管理 Kafka 集群配置](kafka-manager_init2.png)
...
![集群列表 ](kafka1.0.0_info.png)

 点击集群 ID 可以查看该集群的详细信息：

![集群信息](kafka1.0.0_nodes_info.png)
...
### 配置参数
  ...
  ![参数配置](params_update.png)

### 扩容集群

  点击 `扩容集群`，可以在集群性能不足时提高集群的配置：

  ![集群扩容](kafka1.0.0_cluster_resize.png)
