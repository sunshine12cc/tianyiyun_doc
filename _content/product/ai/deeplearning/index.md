...
青云深度学习平台提供入门版、基础版和企业版三个版本，其中企业版搭载 NVIDIA Tesla P100 GPU，在 docker 宿主机中安装 NVIDIA Driver(387.26/418.87)，nvidia-docker2，Docker(18.09.6)，基础版搭载 AMD GPU，在 docker 宿主机中安装 ROCm 2.6.22，Docker(18.09.7)，入门版 docker 宿主机上安装 Docker(18.09.6)，宿主机上预置了一个 docker 镜像，镜像中均安装 Caffe(1.0，基础版硬件不支持未内置),  TensorFlow(1.12.0/1.14.0),  Keras(2.2.4/2.3.1),  PyTorch(1.1.0/1.2.0) 框架。
...
- 更新适用于青云云平台多个 docker 镜像，镜像整合 Python 版本(2.7和3.6)、更新框架版本、增加 CUDA 10.0 支持
- 支持 NeonSAN
